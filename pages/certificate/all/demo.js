...
export default function Demo() {
  ...
  return (
    ...
    {(advisor || principal) && client && <PDFViewer width={1600} height={1000}>
      <Certificate name={'Afthar K P'} prize={0} 
      dept={'ME'} year={'2'} event={'Poem Writing Malayalam'} 
      id={'54756'}/>
    </PDFViewer>}

    <div className='flex flex-col mt-10'>
        {advisor && <div className='flex flex-col space-y-2 bg-zinc-800 text-white rounded-lg px-4 py-6 justify-center items-center'>
            <h6 className='text-center'>Upload Advisor Signature</h6>
            <input type='file' placeholder='s' accept='.png' 
       ...
       { principal && <div className='flex flex-col space-y-2 bg-zinc-800 text-white rounded-lg px-4 py-6 justify-center items-center'>
